...
if [ "$ROS_DISTRO" = "kinetic" ]; then
	...
	# git -C $CATKIN_SRC_DIR/navigation pull			|| git -C $CATKIN_SRC_DIR clone https://github.com/ros-planning/navigation.git -b kinetic-devel
	...
	# git -C $CATKIN_SRC_DIR/navigation pull			|| git -C $CATKIN_SRC_DIR clone https://github.com/ros-planning/navigation.git -b melodic-devel
