# Драйвер для контроллера zaWRka

## Подготовка

- Set environment `CHIBIOS_ROOT` as path to ChibiOS version 17 directory.

Like this:

```bash
export CHIBIOS_ROOT=$HOME/ChibiStudio/chibios176
```

- Don`t forget to send ssh-key to zaWRka
